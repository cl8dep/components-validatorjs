...
class Handler {
  ...
  private _validationRules: Rules;
  private _formState: any;
  private _invalidations: any;
  private _validationMessages: ErrorMessages | undefined;
  private _stateFieldName: any;
  private _stateUpdater: any;
  private _initialFormState: any;
  ...
  constructor(props: IHandlerProps) {
    ...
    this._fields = Object.keys(rules);
  ...
  _prepareState(data: InitialData) {
    this._formState = getInitialState(this._fields, {initialData: data});
  ...
  clearForm() {
    this._formState = getInitialState(this._fields, {});
    return this;
  }
